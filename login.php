...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    /**
     * The SQL statement is using a parameterized query with a placeholder (the ? character) for the username.
     * This is a crucial security measure to prevent SQL injection attacks, where an attacker could potentially
     * manipulate the SQL query by injecting malicious SQL code through user input. By using a parameterized query,
     * the input is treated as a value rather than executable code, thus enhancing the security of the application.
     */
